...
const Question1 = () => {
    ...
    return(
        <View style={styles.container}>
            ...
            <CustomButton frontColor="#000000" backColor="#6FE7C3" text="Yes" onPress={onQuestion2Pressed}/>
            <CustomButton frontColor="#000000" backColor="#EA5E6A" text="No" onPress={onQuestion2Pressed}/>
        </View> 
    );
};
